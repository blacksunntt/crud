...
public class SearchProductsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String searchStr = request.getParameter("q").trim();
        ...
        int num_records = productDao.countSearchProduct(searchStr);
        //caculated the number of page to pagging
        int totalPage = (num_records % pageSize == 0) ? num_records / pageSize : num_records / pageSize + 1;

        ArrayList<Product> products = productDao.searchProducts(pageIndex, pageSize, searchStr);
